...
<!--icons-css-->
<link href="<?php echo base_url(); ?>aassets/css/font-awesome.css" rel="stylesheet"> 
<!--Google Fonts-->
    	 ...
    	 <div class="login-head">
			...
			<div class="login-block">
				<form method="post" action="<?php echo base_url();?>index.php/login/process">
					...
					<h3>Sudah Terdaftar?<a href="<?php echo base_url();?>index.php/pegawai/adduser"> Daftar Sekarang</a></h3>				
					<h2>Contact</h2>
